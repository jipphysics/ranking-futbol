...
\end{itemize}
where \verb+LIGA+ is any of the leagues and \verb+METRIC+ is any of the metrics.
...
\quad \verb+i w_i r_i tr_i+

denoting the label or number associated to each node $i$, the corresponding rating $w_i$, the corresponding ranking $r_i$ and the corresponding true rating \verb+tr_i+.
...
\quad \verb+l i j f_ij g_ij s_ij h_ij+

denoting the label or number $l$ associated to each link, the corresponding nodes $i$ and $j$, and the corresponding components of $f$, $g$, $s$ and $h$ on such link.
...
\quad \verb+t i j k u_ijk+

denoting the label or number $t$ associated to each triangle, the corresponding nodes $i$, $j$ and $k$, and the corresponding components of the $u$.
