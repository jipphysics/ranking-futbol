...
\caption{}
\label{tab:comp}
\tiny % Ajuste de tamaño 
%
 \begin{tabular}{|c| *{15}{c|} } 
 \toprule 
 Metric& \multicolumn{3}{c|}{England} & \multicolumn{3}{c|}{France} & \multicolumn{3}{c|}{Germany} & \multicolumn{3}{c|}{Italy} & \multicolumn{3}{c|}{Spain} \\ 
 \midrule 
& $\tau_{HR}$ & $\tau_{BT}$ & Impr. & $\tau_{HR}$ & $\tau_{BT}$ & Impr. & $\tau_{HR}$ & $\tau_{BT}$ & Impr. & $\tau_{HR}$ & $\tau_{BT}$ & Impr. & $\tau_{HR}$ & $\tau_{BT}$ & Impr. \\ 
 \midrule 
 \bottomrule 
 \end{tabular}  
%
