...
En la Fig. \ref{fi:stats} (a), mostramos la cumulative distribution function (CDF) del true rating, el ajuste realizado a partir del multinomial direchlet model (M-D model) desarrollado arriba, y de una densidad gaussiana de valor medio y desviacion estandar igual al valores muestrales $\bar{R}_T=51.31$ $(s_{R_T}=17.89)$.
