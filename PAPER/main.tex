...
The weights $w_i$ minimizing sum represent the inferred ratings associated to the given metric defining the components $f_{ij}$.
Physically, we may think of the ratings $w_i$ as potential energies defined on the nodes and $f_{ij}$ as forces.
In this way, the minimization of the sum results in the potentials $w_i$ reproducing the forces $f_{ij}$ as close as possible in a least squares sense.

To infer metric-based team ratings, we use {\em HodgeRank}, which is a method based in the theory of Discrete Calculus over Higher Order Networks~\cite{jiang2011statistical,grady2010discrete,lim2020hodge,bianconi2021higher,perotti2025analysis}.
