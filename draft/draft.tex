...
One way to obtain rating scores somehow consistent with the pairwise comparisons scores, consist in finding ratings $w_i$ for $i=0,1,..,n$ such that minimize the sum of squared differences
$$
