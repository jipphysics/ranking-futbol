...
To review the HodgeRank method for the infrence of ratings and rankings, the theory of discrete exterior calculus on simplicial complexes has to be reviewed first.
...
of $k$-simplices
$$
K_k \subseteq \{\{i_0,...,i_k\} : i_0,...,i_k \in V\}
$$
