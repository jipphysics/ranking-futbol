...
The data comprehends 5 soccer leagues from England, France, Germany, Italy and Spain.
Each has 20 teams, with the exception of Germany which has 18.
For each pair of teams $i$ and $j$ of a given league, a score $\phi_{ij}\in \RR$ is provided, which is the aggregate of the two games between them, one as a local and another as a visitor.
There are ten different types of scores:
\begin{enumerate}
\item {\bf crossings:}
