...
Each pair of teams of each league plays two games, one as local and another the visitor.
For each game between two teams $i$ and $j$ of a given league, a score $\phi_{ij}\in \RR$ is provided.
