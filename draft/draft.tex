...
$$
where $\partial_k$ is the restriction of $\partial$ to the subspace $C_k$ and, in particular, $\partial_0=0$.
...
Note, $\partial^*(C_{k-1})\subseteq C_k$ and $d^*(C_{k+1}^*)\subseteq C_k^*$.
